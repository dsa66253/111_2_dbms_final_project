...
class ps_server():
    ...
    def mysql_init(self):
        ...
        self.cursor.execute('DROP DATABASE pub_sub')
            ...
            while True:
                ...
                if message.startswith("#"):
                    ...
                    if message[:3] in ["SUB", "sub"]:
                        ...
                        await asyncio.wait([client.send(connected_clients_id_name[client] +" send: "+ message[4:]) for client in to_inform])
...
if __name__ == '__main__':
    ...
    parser.add_argument("user", type=str, help="User to login MySQL")
    parser.add_argument("password", type=str, help="Password to login MySQL")
